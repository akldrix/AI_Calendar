...
const CalendarGrid: React.FC<CalendarGridProps> =
    ({
        ...
        const [arrow] = useState<"Show" | "Hide">("Show");

        const mergedArrow = useMemo(() => {
            return arrow === "Show";
        }, [arrow]);
        const renderPopoverContent = (dayTasks: Task[]) => (
            <div>
                {dayTasks.length > 0
        ...
        const formatPrevDate = (dayNum: number) => {
        ...
        return (
            <div className="calendar-grid">
                ...
                {prevDays.map((day, i) => {
                    ...
                    const undoneTasks = dayTasks.filter((task: Task) =>
                        ...
                        <div key={`prev-${i}`} className="day-cell prev" style={{cursor: "default"}}>
                            ...
                            <div>
                                <div className="tasks-dots">
                                    {undoneTasks.slice(0, maxDots).map((task: Task) => (
